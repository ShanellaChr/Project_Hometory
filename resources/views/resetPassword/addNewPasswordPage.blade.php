    ...
    <div class="container text-align-center justify-content-center align-items-center d-flex vh-100 flex-column">
        ...
        <form action="{{ route('password.update') }}" method="POST" style="width: 400px;">
            ...
            <div class="mb-3">
                ...
                <input type="password" name="password_confirmation" class="form-control form-control-lg nunito-medium"
                    id="inputConfirmPassword" placeholder="Confirm your new password" required>
            </div>
