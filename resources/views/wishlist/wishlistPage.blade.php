    ...
    <div class="container mt-0 card bg-dark-blue text-white shadow-lg p-3 rounded-4 position-relative" style="background-color: #364156;">
        ...
        <div class = "container position-relative mt-4">
            ...
            <div class="position-absolute bottom-0 end-0">
                <a href = "../wishlist/crudWishlistPage.blade.php" class="btn btn-orange btn-orange-hover text-black rounded-3 px-4 pe-4 shadow-lg gap-2" style="padding-bottom: 0.8vw; padding-top: 0.8vw; display: flex; align-items: center;">
