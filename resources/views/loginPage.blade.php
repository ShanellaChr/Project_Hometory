                ...
                <div class="position-absolute top-50 start-50 translate-middle" style="width: 400px;">
                    ...
                    <form action="{{ url('/login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" class="form-control form-control-lg nunito-medium" id="inputUsername"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control form-control-lg nunito-medium" id="inputPassword"
                        ...
                        <div class="mt-3 mb-5">
                            ...
                            <a href="{{ url('/signup') }}" class="montserrat-bold text-decoration-none text-orenyedija">Sign Up</a>
                        </div>
                    </form>
                    ...
                    @if ($errors->has('username_not_found'))
                        <div class="alert alert-danger mt-3 text-center">{{ $errors->first('username_not_found') }}</div>
                    @endif
