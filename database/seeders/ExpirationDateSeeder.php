...
class ExpirationDateSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('expiration_dates')->insert([
            ...
            ['user_id' => 2, 'item_id' => 5,  'expiration_date' => '2025-06-09', 'qty' => 1], // expired
            ['user_id' => 2, 'item_id' => 5,  'expiration_date' => '2025-09-22', 'qty' => 1],

            ['user_id' => 2, 'item_id' => 6,  'expiration_date' => '2026-02-08', 'qty' => 2],
            ['user_id' => 2, 'item_id' => 7,  'expiration_date' => '2025-08-12', 'qty' => 1], // pepsodent

            // ITEM ID 8: INDOMIE - Ada yang expired
            ['user_id' => 2, 'item_id' => 8,  'expiration_date' => '2025-05-05', 'qty' => 2], // expired
            ['user_id' => 2, 'item_id' => 8,  'expiration_date' => '2025-10-20', 'qty' => 5],

            ['user_id' => 2, 'item_id' => 9,  'expiration_date' => '2025-07-07', 'qty' => 6], // chitato
            ['user_id' => 2, 'item_id' => 10, 'expiration_date' => '2025-08-17', 'qty' => 2], // sarden
            ...
            ['user_id' => 2, 'item_id' => 13, 'expiration_date' => '2025-05-25', 'qty' => 1], // expired
            ...
            ['user_id' => 2, 'item_id' => 16, 'expiration_date' => '2025-06-05', 'qty' => 6], // expired
            ...
            ['user_id' => 2, 'item_id' => 22, 'expiration_date' => '2025-07-02', 'qty' => 1], // expired
            ['user_id' => 2, 'item_id' => 22, 'expiration_date' => '2025-09-08', 'qty' => 2],

            // ITEM ID 23: PANADOL - Ada yang expired
            ['user_id' => 2, 'item_id' => 23, 'expiration_date' => '2025-06-21', 'qty' => 2], // expired
